...
public class TestRegistrazioneDAO {
    ...
    private AccountModelDS userDAO;
    private AccountUtente utenteEsistente;
    private AccountUtente utenteNonEsistente;
    ...
    userDAO = new AccountModelDS(ds);
    utenteEsistente = new AccountUtente();
    utenteEsistente.setNickname("PPEsistente");
    utenteEsistente.setPassword("e21fc56c1a272b630e0d1439079d0598cf8b8329");
    System.out.println("ok");
    userDAO.doSave(utenteEsistente);

    utenteNonEsistente = new AccountUtente();
