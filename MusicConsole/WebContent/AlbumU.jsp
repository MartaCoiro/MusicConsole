...
<html lang="it">
<head>
<% Album al = (Album)request.getAttribute("AlbumI");%>
<meta charset="UTF-8">
...
<button id="carrello" onClick="avvisoc()"><img src="./imgs/carrello.png" height="45px" alt="Foto carrello"></button> 
 ...
 <button id="bott2" onClick="avviso()">Aggiungi al Carrello</button>
 ...
 <p class="streaming"> Formato <br>
  ...
  <button id="bott1" onClick="avviso()">Aggiungi al Carrello</button>
...
<div class="AchilleLauro img-thumbnail" style="background-image: url(./imgs/<%=al.getImgAlbum()%>)"> 
</div>  
</div>
