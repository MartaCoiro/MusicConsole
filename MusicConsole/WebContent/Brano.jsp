...
<head>
<%
Brano br = (Brano)session.getAttribute("BranoI");
%>
<meta charset="UTF-8">
...
function passa(){
	...
	$.getJSON("ServletInf?prezzo=<%=br.getPrezzo()%>&autore=<%=br.getCantante()%>&nome=<%=br.getTitolo()%>&tipo=Streaming",function(result){
		if(result.flag){
