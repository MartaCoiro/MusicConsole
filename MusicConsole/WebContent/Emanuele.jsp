...
function passa(){
	...
	$.getJSON("ServletInf?prezzo=10.50&autore=Geolier&nome=Emanuele&tipo=Streaming",function(result){
		if(result.flag){
...
function passa1(){
	var xhttp = new XMLHttpRequest();
	$.getJSON("ServletInf?prezzo=57.50&autore=Geolier&nome=Emanuele&tipo=Vinile",function(result){
		if(result.flag){
		alert("Elemento aggiunto al carrello");
		} else{
		alert("Elemento gia' presente nel carrello");
...
function passa2(){
	var xhttp = new XMLHttpRequest();
	$.getJSON("ServletInf?prezzo=22.50&autore=Geolier&nome=Emanuele&tipo=CD",function(result){
		if(result.flag){
		alert("Elemento aggiunto al carrello");
		}else{
		alert("Elemento gia' presente nel carrello");
...
<a href="${pageContext.request.contextPath}/ServletCarrello"><button id="carrello" onClick=""><img src="./imgs/carrello.png" height="45px" alt="Foto carrello"></button></a> 
 ...
 <h2 id="testo">Emanuele - Geolier</h2>
 <hr>
...
<div class="Geolier img-thumbnail" style="background-image: url(./imgs/img22.png)"> 
	</div> 
	</div> 
	
	<h4><hr> Brani </h4>
	<h5 class="inf"> L'Album ha una durata di 47:14 min ed &egrave; stato pubblicato il 10 Ottobre 2019. </h5>
	<p class="brani b">
    1) Intro 2:02
    <br>
    2) Senz e me 2:25
    ...
    11) Mala 2:58
    <br>
    12) Vogl sul a te 3:06
    <br>
    13) Mamacita 3:16
    <br>
    14) New York 2:25
    <br>
    15) Amo Ma Chi T Sap 3:30
    <br>
    16) Emanuele 2:46
    <br>
</p>
