...
%>
	<div class="alert alert-danger alert-dismissible fade show">
	   <button type="button" class="close" data-dismiss="alert">&times;</button>
		<strong>Attenzione!</strong> Questo brano è stato già pubblicato.
		</div>
<% 
}
%>
...
<h2 class="p">Nuovo Brano:</h2>
<div class="new">
<form action="ServletAggB" id="fo" name="form1" method="POST" enctype="multipart/form-data" onsubmit="event.preventDefault(); validate(document.form1);">
...
<label for="genere"  class="lab">Genere:<select name="genere">
...
<label for="tipo" class="lab">Tipo:<input type="text" name="tipo" placeholder="Brano" required></label><br>
<label for="suono" class="lab">Brano:<input type="file" name="suono" required></label><br>
